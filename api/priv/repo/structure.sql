...
CREATE TABLE public.bookmarks (
    id bigint NOT NULL,
    bookmark_title character varying(255),
    bookmark_url character varying(255),
    bookmark_notes character varying(255),
    category_id bigint,
    user_id bigint,
...
CREATE TABLE public.categories (
    ...
    category_notes character varying(255),
    user_id bigint,
    inserted_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);
...
--
-- Name: bookmarks_category_id_index; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX bookmarks_category_id_index ON public.bookmarks USING btree (category_id);


--
-- Name: bookmarks_user_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: bookmarks bookmarks_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
INSERT INTO public."schema_migrations" (version) VALUES (20180612151626), (20180613162457), (20180613163539), (20180613183925);
